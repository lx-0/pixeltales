...
from sqlalchemy.types import JSON, Float, Integer, Enum, String

from app.config import SYSTEM_PROMPT
from app.db.database import Base
from app.core.config import settings
from app.models.scene import CreateSceneConfig, SceneState, SceneStatus
...
class DBSceneConfig(Base):
    ...
    status: Mapped[SceneStatus] = mapped_column(
        Enum(SceneStatus), default=SceneStatus.PROPOSED
    )
