...
- [P] Implement logic within specific internal tool methods (Memory tools delegated; others are stubs).
- [ ] Implement logic within capability extensions (interacting with simulation layer).
