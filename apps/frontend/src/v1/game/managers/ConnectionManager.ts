...
export class ConnectionManager {
  ...
  private setupEventListeners(): void {
    ...
    socketV1Service.addListener('connect', this.onConnect);
    socketV1Service.addListener('disconnect', this.onDisconnect);
    socketV1Service.addListener('connect_error', this.onConnectError);
  }
  ...
  destroy(): void {
    socketV1Service.removeListener('connect', this.onConnect);
    socketV1Service.removeListener('disconnect', this.onDisconnect);
    socketV1Service.removeListener('connect_error', this.onConnectError);
