...
export class HistoryManager {
  ...
  private conversationHistory: SceneStateSnapshot['messages'] = [];
  private scene: Scene;
  ...
  private setupEventListeners(): void {
    ...
    this.scene.game.events.on('sceneStateUpdate', (state: SceneStateSnapshot) => {
  ...
  getConversationHistory(): SceneStateSnapshot['messages'] {
