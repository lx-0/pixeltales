...
import { LlmConfig, LlmProviderId } from '@pixeltales/contracts';
import { z } from 'zod';
...
export type TaskType = 'image_generation' | 'image_recognition';
...
export class LlmService {
  ...
  // private initConversationLlm(config: LlmConfig): void {
  ...
  //  */
  // private initConversationLlms(): void {
  ...
  //     this.initConversationLlm(config);
  //   }
