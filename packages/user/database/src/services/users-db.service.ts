...
import { USER_DB_DI_TOKEN } from '../tokens';
import { DbUser, NewDbUser, usersTable } from '../user';

const usersDbSchema = { usersTable };
...
export class UsersDbService {
  constructor(
    @Inject(USER_DB_DI_TOKEN) private readonly db: BetterSQLite3Database<typeof usersDbSchema>,
